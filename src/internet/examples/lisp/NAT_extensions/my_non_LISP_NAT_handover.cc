...
NS_LOG_COMPONENT_DEFINE ("NonLISPNATHandover");
...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  LogComponentEnable ("NonLISPNATHandover", LOG_LEVEL_INFO);
  ...
  */
  ...
  lispHelper.BuildRlocsSet ("./non_lisp_nat_handover_lisp_rlocs.txt");
  lispHelper.SetRtrs(NodeContainer(nodes.Get (9)));
  lispHelper.Install(lispRouters);
  NS_LOG_INFO("Lisp router installed");
  lispHelper.BuildMapTables2("./non_lisp_nat_handover_lisp_rlocs_config_xml.txt");
