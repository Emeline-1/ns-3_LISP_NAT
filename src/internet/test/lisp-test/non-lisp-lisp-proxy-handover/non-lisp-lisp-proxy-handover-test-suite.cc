...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE ("NonLispLispProxyHandoverTestSuite");

class NonLispLispProxyHandoverTestCase : public TestCase
{
public:
  NonLispLispProxyHandoverTestCase ();
  virtual ~NonLispLispProxyHandoverTestCase ();
...
NonLispLispProxyHandoverTestCase::NonLispLispProxyHandoverTestCase ()
  : TestCase ("MN LISP test case: checks nonLisp -> Lisp handover"), m_receivedPacket_first_interface(false), m_receivedPacket_second_interface(false)
{
}
...
void 
NonLispLispProxyHandoverTestCase::RxSink (Ptr<const Packet> p)
{
...
void
NonLispLispProxyHandoverTestCase::DoRun (void)
{
  ...
  */
  ...
  LogComponentEnable ("NonLispLispProxyHandoverTestSuite", LOG_LEVEL_INFO);
  ...
  lispHelper.BuildRlocsSet ("src/internet/test/lisp-test/non-lisp-lisp-proxy-handover/nonLisp_Lisp_proxy_handover_lisp_rlocs.txt");
  lispHelper.Install(lispRouters);
  NS_LOG_INFO("Lisp router installed");
  lispHelper.BuildMapTables2("src/internet/test/lisp-test/non-lisp-lisp-proxy-handover/nonLisp_Lisp_proxy_handover_lisp_rlocs_config_xml.txt");
  ...
  clientApps.Get (0)->TraceConnectWithoutContext ("Rx", MakeCallback (&NonLispLispProxyHandoverTestCase::RxSink, this));
...
// ===================================================================================
class NonLispLispProxyHandoverTestSuite : public TestSuite
{
public:
 NonLispLispProxyHandoverTestSuite ();
};
NonLispLispProxyHandoverTestSuite::NonLispLispProxyHandoverTestSuite ()
  : TestSuite ("non-lisp-lisp-proxy-handover", UNIT)
{
  AddTestCase (new NonLispLispProxyHandoverTestCase, TestCase::QUICK);
}

static NonLispLispProxyHandoverTestSuite nonLispLispProxyHandoverTestSuite;